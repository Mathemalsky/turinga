...
void rotate(Byte* rotorShifts, const size_t length) {
  ...
  __m256i factor = _mm256_setr_epi8(
  ...
  __m256i y      = _mm256_and_si256(values, low_4_bits_mask);

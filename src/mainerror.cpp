...
void syntaxCrypt() {
  ...
  std::cout<<"    input_filename  : path and filename (with ending) of the file to be encrypted/decrypted\n";
  std::cout<<"    key             : path and filename (with ending) of the key used to be encrypt/decrypt\n";
